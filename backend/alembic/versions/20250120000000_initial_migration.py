...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('contract_type', sa.Enum('SALES', 'PURCHASE', 'SERVICE', 'OTHER', name='contracttype'), nullable=False),
        sa.Column('file_path', sa.String(500), nullable=False),
        sa.Column('ocr_text_path', sa.String(500)),
        sa.Column('status', sa.Enum('PENDING_OCR', 'PENDING_AI', 'REVIEW_REQUIRED', 'COMPLETED', 'FAILED', name='contractstatus'), nullable=False, server_default='pending_ocr'),
    ...
    op.create_table(
        ...
        sa.Column('party_type', sa.Enum('PARTY_A', 'PARTY_B', 'OTHER', name='partytype'), nullable=False),
